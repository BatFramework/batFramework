...
class Animation:
    ...
    def from_surface(
        self, surface: pygame.Surface, frame_size: Tuple[int, int]
    ) -> Self:
        """
    ...
    def from_path(
        self, path: str, frame_size: Tuple[int, int], convert_alpha: bool = True
    ) -> Self:
        """
    ...
    def get_frame(
        self, counter: Union[float, int], flipX: bool = False, flipY: bool = False
    ) -> pygame.Surface | None:
        if not self._frames:
            return None
