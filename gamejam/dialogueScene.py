...
class DialogueScene(CustomBaseScene):
    ...
    def say(self,message,character=None,emotion=None,facing_right=True,callback=None):
        ...
        # print(message)
        self.text_box.set_visible(True)
        self.text_box.queue_message(message,end_callback=lambda : [self.text_box.set_visible(False),callback()])
    ...
    def set_emotion(self,emotion=None):
        if self.current_character is None : 
            ...
            self.character_sprite.set_image(f"sprites/{self.current_character}/{emotion}.png",True)
        self.character_sprite.set_visible(True)
